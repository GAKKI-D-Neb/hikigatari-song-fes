...
const organizer = {
  name: "D-Neb（GAKKI）",
  xUrl: "https://x.com/GAKKI_D_Neb",
  icon: "/organizer-icon.png",
};

// 担当者決定後に設定してください。画像は frontend/public/ に配置します。
const illustrator = {
  name: "担当者未定",
  xUrl: "",
  icon: "",
...
// TwiPla公開後にURLを設定してください。
const twiplaUrl = "https://x.com/GAKKI_D_Neb";

export default function Home() {
  const credits = [
    { role: "ORGANIZER", label: "主催", ...organizer },
    { role: "ILLUSTRATION", label: "キービジュアル", ...illustrator },
  ];
    ...
    <>
      ...
      <section className="hero hero--compact">
        <div className="hero__content">
          <p className="eyebrow">HIKIGATARI SONG FESTIVAL 2027</p>
          <h1>弾き語り曲投稿祭 2027</h1>
        ...
        <div className="hero__visual">
          <img
            src={`${basePath}/hero-placeholder.svg`}
            alt="弾き語り曲投稿祭 キービジュアル（仮）"
          />
        </div>
      </section>

      {/* CONCEPT：見出し・本文ともに枠なし */}
          ...
          <dl className="event-summary">
            ...
            <div>
              ...
              <dd className="copyable-value">
                ...
                <CopyTextButton value="弾き語り曲投稿祭2027" />
              </dd>
            </div>
            <div>
              <dt>Xでの告知タグ</dt>
      ...
      <section className="section section--compact">
        ...
        <div className="related-links">
          {twiplaUrl ? (
            ...
            <div className="related-link-card related-link-card--disabled">
              <div>
                <span className="related-link-card__label">
                  TwiPla
                </span>
      ...
      {/* CREDITS */}
      <section className="section section--compact credits-section">
        <div className="section-heading">
        ...
        <div className="credits-grid">
          {credits.map((person) => (
            <div className="credit-card" key={person.role}>
              <div className="credit-card__profile">
                ...
                <div className="credit-card__info">
                  ...
                  <p className="credit-card__label">{person.label}</p>
                  <h3>{person.name}</h3>
                </div>
              </div>
              {person.xUrl ? (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label={`${person.name}のXプロフィール`}
                >
                  <span className="credit-card__x-icon" aria-hidden="true">𝕏</span>
                  <span>Xプロフィール</span>
                  <span aria-hidden="true">↗</span>
                </a>
              ) : (
                <span className="credit-card__pending">準備中</span>
              )}
            </div>
          ))}
        </div>
