  ...
  return (
    <section className="page-section">
      <div className="page-heading">
        ...
        <h1>参加ガイド</h1>
        <p>弾き語り曲投稿祭2027 参加の流れと、作品に関するルールを掲載しています。</p>
      </div>
      ...
      <section className="guide-section">
        ...
        <div className="participation-group">
          <div className="section-heading section-heading--small">
            <p className="eyebrow">FOR LISTENERS</p>
            <h3>視聴者の方へ</h3>
          </div>
          ...
          <div className="flow-list">
            ...
            <div className="flow-item">
              ...
              <div>
                ...
                <Link className="text-link" href="/comments">
                  感想掲示板を見る →
                </Link>
              </div>
            </div>
      ...
      <section className="guide-section guide-section--rules" id="rules">
        <div className="section-heading section-heading--small">
        ...
        <div className="prose-layout">
          <section className="prose-card">
            ...
            <div className="required-rules">
              <p className="rules-caption">必須条件</p>
              <ul className="rule-list rule-list--required">
                <li>オリジナル曲であること</li>
                <li>開催期間中にニコニコ動画へ新規投稿する動画であること</li>
                <li>歌唱を含め、一人で演奏可能な構成の曲であること</li>
              </ul>
            </div>

            <div className="supplement-rules">
              <p className="rules-caption">補足</p>
              <ul className="rule-list">
                <li>ボカロ曲投稿祭として開催しますが、人間歌唱のオリジナル曲での参加も歓迎します</li>
                <li>動画として新規投稿であれば、過去に発表した曲の弾き語りアレンジなどでも参加可能です</li>
                <li>他投稿祭との同時参加も可能です（同時参加先のルールにも従ってください）</li>
              </ul>
            </div>
          </section>

          <section className="prose-card prose-card--accent">
            <h3>「一人で演奏可能」の考え方</h3>
            <p>
              弾き語り曲投稿祭では、歌唱を含め、一人で演奏可能な構成の楽曲を募集しています。<br />
              「ステージに一人だけで立ち、その人の歌唱・演奏で楽曲を成立させられるか」を基準としてください。<br />
            ...
            <div className="rule-example-table-wrap">
              <table className="rule-example-table">
                ...
                <tbody>
                  <tr>
                    <td><span className="status-badge status-badge--ok">OK</span></td>
                    <td>歌＋ピアノ、歌＋ギターなどの一般的な弾き語りの構成</td>
                  </tr>
                  <tr>
                    <td><span className="status-badge status-badge--ok">OK</span></td>
                    <td>歌＋ギター＋ハーモニカ（間奏）など、複数の楽器でも一人で演奏できる構成</td>
                  </tr>
                  <tr>
                    <td><span className="status-badge status-badge--ok">OK</span></td>
                    <td>曲中で楽器を持ち替えながら、複数の楽器を一人で演奏する構成</td>
                  </tr>
                  <tr>
                    <td><span className="status-badge status-badge--ng">NG</span></td>
                    <td>歌+ピアノ+バイオリンなど、一人では同時に演奏できない構成</td>
                  </tr>
                  <tr>
                    <td><span className="status-badge status-badge--ng">NG</span></td>
                    <td>歌と同時にハーモニカを演奏するなど、歌唱を含めて一人では演奏できない構成</td>
                  </tr>
                  <tr>
                    <td><span className="status-badge status-badge--ng">NG</span></td>
            ...
            <p className="form-note">
              ...
              ただし、本投稿祭は「一人で演奏可能な限界」を競うことが目的ではありませんので、投稿祭の趣旨をご理解いただいた上で、ご参加をお願いいたします。
            </p>
          </section>
        </div>
      </section>
